...
class game_sprite final : public sprite
{
    ...
    float                 current_pos_x   = 0.f;
    float                 current_pos_y   = 0.f;
...
public:
    ...
    void move(float x, float y) final
    {
        current_pos_x += x;
        current_pos_y += y;
        std::cout << current_pos_x << " " << current_pos_y << std::endl;
    }
    float      get_current_pos_x() final { return current_pos_x; }
    float      get_current_pos_y() final { return current_pos_y; }
